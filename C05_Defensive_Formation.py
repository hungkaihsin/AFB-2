...
def main_test_defensive_formation():
    ...
    f1 = DefensiveFormation('4-4', dl=[90, 92, 94, 96], lbs=[50, 52, 54, 57], cbs=[22, 23], safeties=[25])
    f2 = DefensiveFormation('6-2', dl=[90, 91, 92, 94, 95, 96], lbs=[52, 54], cbs=[22, 23], safeties=[25])
